...
const EditTripPage = () => {
  ...
  const derivedItinerary = useMemo<DayEntry[]>(() => {
    ...
    return dates.map(
      (d) => itinerary.find((e) => e.date === d) ?? { date: d, locations: [] },
    );
  ...
  const handleStartDate = (value: string) => {
    ...
    setItinerary(
      dates.map(
        (d) =>
          itinerary.find((e) => e.date === d) ?? { date: d, locations: [] },
      ),
    );
  ...
  const handleEndDate = (value: string) => {
    ...
    setActiveDate((prev) =>
      prev && dates.includes(prev) ? prev : (dates[0] ?? null),
    );
  };
  ...
  return (
    ...
    >
          ...
          <div>
            ...
            {derivedItinerary.length > 0 && (
              <p className="mt-1 text-sm text-gray-500">
                {derivedItinerary.length} day
                {derivedItinerary.length !== 1 ? "s" : ""} •{" "}
                {itinerary.reduce((a, d) => a + d.locations.length, 0)}{" "}
                locations
              </p>
            )}
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pr-3 pl-9 text-sm text-gray-900 placeholder-gray-400 shadow-sm transition outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                />
              </div>
            </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pr-3 pl-9 text-sm text-gray-700 shadow-sm transition outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                  />
                </div>
            ...
            <div className="space-y-3">
              ...
              {activeDay.locations.map((loc, idx) => (
                ...
                >
                  ...
                  <div>
                    <label className="mb-1 flex items-center gap-1.5 text-xs font-semibold tracking-widest text-gray-400 uppercase">
                    ...
                    <textarea
                      ...
                      className="w-full resize-none rounded-xl border border-gray-100 bg-slate-50 px-3 py-2 text-xs text-gray-700 placeholder-gray-400 transition outline-none focus:border-violet-300 focus:ring-2 focus:ring-violet-50"
                    />
                  </div>
                </div>
              ))}
      ...
      >
        {allMarkers.length > 0 && (
          <div className="absolute top-4 left-4 z-[1000] rounded-2xl bg-white/90 px-4 py-2 shadow-lg backdrop-blur-sm">
